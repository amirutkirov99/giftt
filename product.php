      ...
      <nav>
        <div class="nav-wrapper">
          <div class="col s12">
            ...
            <a href="product.php?id=<? $id_product; ?>" class="breadcrumb">Товар</a>
          </div>
        </div>
      </nav>
    </div>
   ...
   <div class="row">
     <div class="col s12 m6">
       ...
       <div class="row">
         ...
         //get categories
           $querypic = "SELECT thumbnail FROM product WHERE id = '$id_productdb'";
     ...
     <div class="col s12 m6">
       ...
       <div class="center-align">
           <button type="submit" name="buy" class="btn-large meh button-rounded waves-effect waves-light ">Добавить в корзину</button>
       </div>
       </div>
        </form>
     </div>
