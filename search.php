 ...
 <div class="container-fluid product-page" id="top">
      ...
      <nav>
        <div class="nav-wrapper">
          <div class="col s12">
            ...
            <a href="search.php" class="breadcrumb">Поиск</a>
          </div>
        </div>
      </nav>
    </div>
   ...
   <div class="container search-page">
     <div class="row">
       ...
       $queryproduct = "SELECT SQL_CALC_FOUND_ROWS id, name, price, thumbnail FROM product WHERE name LIKE '%{$word}%' ORDER BY id DESC LIMIT {$start}, 16";
